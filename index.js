...
const vcard = 'BEGIN:VCARD\n' // ANAK ANJING MAU NGAPAIN ASU!?
            ...
            + 'FN: sakril \n' // NAMA OWNER BOT
            + 'ORG:Creator Sakrilbot;\n' // KASIH CREDITS GUA FADHIL GRAPHY SU!!!
            + 'TEL;type=CELL;type=VOICE;waid=62895324948367:+62 895@3249-498367\n' // GANTI NOMOR LU
            + 'END:VCARD'
prefix = '/'
blocked = []
...
async function starts() {
	...
	client.on('message-new', async (mek) => {
		try {
			...
			const ownerNumber = ["62895324948367@s.whatsapp.net"] // GANTI NOMOR LU
			const adminbotnumber = ["62(089)5324948367@s.whatsapp.net"] // GANTI NOMOR LU
			...
			switch(command) {
				...
				case 'info':
					...
					teks = `➽ *Bot Sakril* : _${me.name}_\n➽ *088245117869* : _@${me.jid.split('@')[0]}_\n➽ *prefix* : _${prefix}_\n➽ *Total Block* : _${blocked.length}_\n➽ *Aktif 24jam* : _${kyun(uptime)}_\n➽ *@muh_sakril.87* : https://www.instagram.com/p/CBgHIY0l0Of/?igshid=17dmy5gwhmwbr\n➽ *YouTube* : https://youtu.be/bv_pv2wb7kY\n➽ *Script By* : _Sakril Gaming__ [Sakril]\n➽ *Note* : _Ini SC pribadi no minta SC_\n➽ *Sepecial Thangks To* :\n➽ _Allah SWT_ \n➽ _Sakril Gaming_ \n➽ _Seluruh member *Bot Sg*_\n➽ _Dewa_\n➽ _Pandi_\n➽ _Aldi_\n➽ _Riro_\n➽ _Dirgam_\n➽ _Dadi_\n➽ _Dias_\n➽ _XP-TN_\n➽_YUKINIKO_\n_DLL_`
			...
			case 'owner':
               ...
               client.reply(from, `Waalaikumsalam ${pushname}:)`)
                ...
                case 'request':
                    ...
                    client.sendMessage('62895324948367@s.whatsapp.net', options, text, {quoted: mek})
